<?php
/**
 * ClionaJoyce functions and definitions.
 *
...
if ( ! function_exists( 'clionajoyce_setup' ) ) :
/**
 ...
 */
function clionajoyce_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on ClionaJoyce, use a find and replace
	 * to change 'clionajoyce' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'clionajoyce', get_template_directory() . '/languages' );
 ...
 */
function clionajoyce_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'clionajoyce_content_width', 640 );
}
add_action( 'after_setup_theme', 'clionajoyce_content_width', 0 );
 ...
 */
function clionajoyce_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'clionajoyce' ),
		'id'            => 'sidebar-1',
		'description'   => '',
 ...
 */
function clionajoyce_scripts() {
	wp_enqueue_style( 'clionajoyce-style', get_stylesheet_uri() );
...
add_action( 'wp_enqueue_scripts', 'clionajoyce_scripts' );
